...
class PinCodeTextField extends StatefulWidget {
  ...
  final List<Widget> Function(List<Widget>) addWidgets;
  ...
  PinCodeTextField({
    ...
    this.dialogConfig,
    this.pinTheme,
    this.keyboardAppearance = Brightness.light, this.addWidgets,
  }) : super(key: key);
...
//    result.insert(4, Text('/'));
//    result.insert(2, Text('/'));

    if (widget.addWidgets != null) {
      result = widget.addWidgets(result);
    }
